 ...
 *					unsigned char bytes, unsigned char *buff, char ack)
 *
 * PreCondition:    None
 *
 ...
 *					given buffer.
 *
 * Note:            When ack = 1, I2C sends ack before stop bit whilst
 *						ack=0 sends nack
 *
 *****************************************************************************/
void I2CGetBytes (unsigned char address, unsigned char bytes, char *buff, char ack)
 ...
 * Side Effects:    None
 *
 * Overview:        This routine gets 2 bytes and store into the
 *					given buffer.
 *
 * Note:            
 *
...
/******************************************************************************
 * Function:        void PrintBmpData (long temperature, long pressure)
 *
 * PreCondition:    None
 *
 * Input:           temperature and pressure value
 *
 * Output:          None
 *
 * Side Effects:    None
 *
 * Overview:        This function prints data on to serial port
 *
 * Note:            
 *
 *****************************************************************************/
...
/******************************************************************************
 * Function:        void BMP085Calibration (void)
 *
 * PreCondition:    None
 *
 * Input:           None
 ...
 * Side Effects:    None
 *
 * Overview:        This function reads the calibrated values
 *
 * Note:            
 *
 *****************************************************************************/
...
/******************************************************************************
 * Function:        unsigned short Bmp085ReadUt(void)
 *
 * PreCondition:    None
 *
 * Input:           None
 *
 * Output:          Uncalibrated temperature value
 *
 * Side Effects:    None
 *
 * Overview:        This function returns the uncalibrated temperature value
 *
 * Note:            
 *
 *****************************************************************************/
...
/******************************************************************************
 * Function:        unsigned short Bmp085ReadUp(void)
 *
 * PreCondition:    None
 *
 * Input:           None
 *
 * Output:          Uncalibrated pressure value
 *
 * Side Effects:    None
 *
 * Overview:        This function returns the uncalibrated pressure value
 *
 * Note:            
 *
 *****************************************************************************/
...
/******************************************************************************
 * Function:        void bmp085Convert(long* temperature, long* pressure)
 *
 * PreCondition:    None
 *
 * Input:           Pointers to temperature and pressure variable
 *
 * Output:          None
 *
 * Side Effects:    None
 *
 * Overview:        This calculates calibrated temperature and pressure
 *
 * Note:            
 *
 *****************************************************************************/
...
{   
	...
	//Commented out the following parts because we do not use serial the serial buffer
